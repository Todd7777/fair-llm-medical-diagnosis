...
from fairtune.metrics.fairness import compute_fairness_metrics, compute_equity_scaled_auc, compute_subgroup_metrics


def parse_args():
    """Parse command line arguments."""
    parser = argparse.ArgumentParser(description="Benchmark models for medical image diagnosis")
    
    parser.add_argument("--config_dir", type=str, default="configs", help="Directory containing configuration files")
    parser.add_argument("--output_dir", type=str, default="results/benchmarks", help="Directory to save results")
    parser.add_argument("--datasets", type=str, nargs="+", default=["chexray", "pathology", "retinal"],
                        help="Datasets to benchmark")
    parser.add_argument("--model_types", type=str, nargs="+", default=["specialized", "llm", "fairlora"],
    ...
    parser.add_argument("--wandb_project", type=str, default="fair-llm-medical-benchmarks",
    ...
    for dataset_name in args.datasets:
        ...
        for model_type in args.model_types:
            ...
            if model_type == "fairlora":
                ...
                model_dirs = [os.path.join(fairlora_dir, d) for d in os.listdir(fairlora_dir)
            ...
            for model_name, model_info in models.items():
                ...
                try:
                    ...
                    if model_type == "fairlora":
                        ...
                        model = load_model(model_type, model_name_or_path, config, args.device)
                    ...
                    group_aucs = [metrics["group_metrics"][group]["auc"] for group in metrics["group_metrics"]]
                    ...
                    for group, group_metrics in metrics["group_metrics"].items():
                        print(f"  {group}: AUC = {group_metrics['auc']:.4f}, "
